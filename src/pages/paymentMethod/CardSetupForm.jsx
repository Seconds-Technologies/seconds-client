...
const SubmitButton = ({ processing, error, children, disabled }) => (
	<Button className='text-light' type='submit' size='lg' disabled={processing || disabled}>
			...
			<div className='row'>
				<div className='col'>
					<div className='form-group'>
						...
						<CardNumberElement className='form-control form-border mb-2'></CardNumberElement>
					</div>
				</div>
