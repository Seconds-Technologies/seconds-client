...
const NewDriver = ({ type, show, toggleShow, onSubmit, details={
	firstname: "",
	lastname: "",
	email: "",
	phone: "",
								...
								<div className='row'>
									...
									<div className='col-sm-8 d-flex justify-content-around'>
										<label className='d-flex align-items-center'>
											<input type='radio' name='test' value='small' checked={values.vehicle === VEHICLE_TYPES[0].value}  onChange={e => setFieldValue('vehicle', VEHICLE_TYPES[0].value)} onBlur={handleBlur}/>
											<img className='img-fluid' src={bicycle} alt={''} width={40} height={40} />
										</label>
										<label className='d-flex align-items-center'>
											<input type='radio' name='test' value='small' checked={values.vehicle === VEHICLE_TYPES[2].value}  onChange={e => setFieldValue('vehicle', VEHICLE_TYPES[2].value)} onBlur={handleBlur} />
											<img className='img-fluid' src={cargobike} alt='' width={50} height={50} />
										</label>
										<label className='d-flex align-items-center'>
											<input type='radio' name='test' value='small' checked={values.vehicle === VEHICLE_TYPES[1].value}  onChange={e => setFieldValue('vehicle', VEHICLE_TYPES[1].value)} onBlur={handleBlur} />
											<img className='img-fluid' src={motorbike} alt='' width={45} height={45} />
										</label>
										<label className='d-flex align-items-end'>
											<input type='radio' name='test' value='small' checked={values.vehicle === VEHICLE_TYPES[3].value}  onChange={e => setFieldValue('vehicle', VEHICLE_TYPES[3].value)} onBlur={handleBlur} />
											<img className='img-fluid' src={car} alt='' width={60} height={60} />
										</label>
										<label className='d-flex align-items-center'>
											<input type='radio' name='test' value='small' checked={values.vehicle === VEHICLE_TYPES[4].value}  onChange={e => setFieldValue('vehicle', VEHICLE_TYPES[4].value)} onBlur={handleBlur} />
											<img className='img-fluid' src={van} alt='' width={60} height={60} />
										</label>
									</div>
									<div className='d-flex justify-content-around mt-5 '>
										<button type='button' className='btn btn-dark' style={{ width: 150, height: 45 }} onClick={() => toggleShow('')}>
											Cancel
										</button>
